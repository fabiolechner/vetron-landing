...
function VetronLogo({ height = 28 }: { height?: number }) {
          ...
          <div className={styles.prodGrid}>
            ...
            <div className={`${styles.pCard} ${styles.pCardCF}`}>
              ...
              <div className={styles.pIcon}>
                <img src="/complianceflow-logo.svg" height={24} style={{display:'block', width:'auto', filter:'brightness(0) invert(1) sepia(8%) saturate(300%) hue-rotate(5deg)'}} alt="ComplianceFlow" />
              </div>
            ...
            <div className={`${styles.pCard} ${styles.pCardDim}`}>
              ...
              <div className={styles.pNameDim}>Quote<em>Pilot</em></div>
              <div className={styles.pCatDim}>KI-Angebotserstellung</div>
              <p className={styles.pDescDim}>
                Email rein, Angebot raus — KI extrahiert Positionen,
                matched Preisliste und erstellt druckfertige PDFs in Minuten statt Stunden.
              </p>
